...
describe('favourite blog', () => {
  ...
  test('when list has only one blog, return that blog', () => {
    ...
    expect(result).toStrictEqual({ author: 'Edsger W. Dijkstra', likes: 5, title: 'Go To Statement Considered Harmful' })
  })
  test('of a bigger list is calculated right', () => {
    const result = listHelper.favoriteBlog(listWithMultipleBlogs)
    expect(result).toStrictEqual({ author: 'Edsger W. Dijkstra', likes: 12, title: 'Canonical string reduction' })
  })
})
